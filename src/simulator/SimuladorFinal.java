...
public class SimuladorFinal {
	...
	private static double getCogumelo(String test) {
		if (test == null)
			return 2.0;
	...
	public static void main(String[] args) throws Exception {
		...
		while (true) {
			...
			String filename = "magicshrooms.fcl";
			...
			fb.setVariable("sensor_direito", distanceC);
			fb.setVariable("speed", speed);

			fb.setVariable("classification", getCogumelo(pred));
			fb.evaluate();

			System.out.println(getCogumelo(pred));
